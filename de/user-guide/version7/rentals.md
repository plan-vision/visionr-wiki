...
Deutsch | [English](/en/modules/rentals/qooxdoo)
...
![Qooxdoo Mieteinheiten erstellen](_images/rentals/mieteinh9.png "Nutzung der Mieteinheit")
...
![Qooxdoo Mietvertrag erstellen](_images/rentals/mietver6.png "Staffelungen")
...
![Qooxdoo Monatliche Werte](_images/rentals/monat_flaeche2.png "Monat / Fläche generieren")

Wenn Sie die Einheiten selektiert haben, klicken Sie auf den Button `Monat / Fläche anlegen`.

![Qooxdoo Monatliche Werte](_images/rentals/monat_flaeche3.png "Monat / Fläche generieren")
...
![Qooxdoo Monatliche Werte](_images/rentals/monat_flaeche4.png "Monat / Fläche generieren Einstellungen vor dem Generieren")
...
![Qooxdoo Monatliche Werte](_images/rentals/monat_flaeche5.png "Monat / Fläche Daten werden generiert")

Die generierten Objekte werden angezeigt. 

![Qooxdoo Monatliche Werte](_images/rentals/monat_flaeche6.png "Monat / Fläche Ergebnis Überblick")
...
![Qooxdoo Monatliche Werte](_images/rentals/monat_flaeche7.png "Monatliche Werte Tabelle")
...
![Qooxdoo Monatliche Werte](_images/rentals/monat_flaeche8.png "Monatliche Werte Ansicht / Filter ändern")
