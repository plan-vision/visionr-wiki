<div style="margin:auto;text-align:center;width:100%;height:900px;color:#AAAAAA">
    ...
    <div style="height:160px"><img style="width:160px" src="_images/_title/flexi-workplace-admin-logo.png"/></div>
    <div style="height:20px"></div>
