...
In der Tabelle mit den Mieteinheiten klicken Sie auf ![Qooxdoo Applikationsmaske - Menü Button](_images/general/menu-button.png "Menü Button")**Neu** in dem Funktionsmenü über die Tabelle rechts oder mit rechter Maustaste wieder auf **Neu**. 
...
Solche Felder, in dem man den Wert mit Datum und Uhrzeit planen kann, sind mit dem Symbol ![Qooxdoo Applikationsmaske - geplante Änderungen](_images/general/planned_changes_icon.png "geplante Änderungen") gekennzeichnet. Falls dieses Zeichen links vor dem Feld verfügbar ist, kann man den Wert in diesem Feld planen. 
...
> Deswegen ist eine geplante Änderung an dieser Stelle sinnvoll. Ein Beispiel ist die MwSt. im Vertrag. 
