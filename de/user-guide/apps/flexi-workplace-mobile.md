...
![Index Seite](_images/flexi-workplace/mobile-index.jpg)
...
![Index Seite](_images/flexi-workplace/mobile-begin.jpg)
...
Der Button mit den drei Strichen ![Menü-Button](../../../menu-button.png)oben links öffnet das Modul-Menü. Das Menü ist auf mobilen Geräten ist aus Platzgründen automatisch versteckt. In der Desktopversion ist das Menü automatisch aufgeklappt. Abwechselndes Klicken auf den`Menü`-Button zeigt oder verbirgt das Menü, je nach den welcher der aktuelle Status ist. Der `Menü`-Button ist auf allen Masken verfügbar. Dur Klick auf einen Menüeintrag in der Liste öffnen Sie die entsprechende Maske mit den in diesem Dokument beschriebenen Funktionalitäten. Der Name der aktiven Maske wird in orangener Farbe hervorgehoben.

![Zur Index](_images/flexi-workplace/mobile-menu-on.jpg)
...
![Zur Index](_images/flexi-workplace/mobile-go-to-index.jpg)
...
![Arbeitsplatzsuche](_images/flexi-workplace/mobile-wpl-search.jpg)
...
Nachdem Sie Ihre Suchkriterien eingegeben haben und auf den Button `Suchen` geklickt haben, wir der Filter-Bereich mit den Suchkriterien automatisch minimiert, um mehr Platz für die Suchergebnisse zu verschaffen. Den Filter mit den Suchkriterien können Sie jederzeit wiedr aufklappen, indem Sie mit dem Finder oder Maus auf die Leiste klicken: ![Filter](_images/flexi-workplace/button-filter-minimized.png)

Als Vorgabe werden die Suchergebnisse im Plan angezeigt:

![Ergebnis Plan](_images/flexi-workplace/mobile-wpl-search-plan.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-wpl-search-legend.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-wpl-search-details.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-wpl-details.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-wpl-search-list.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-reserve.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-reserve-warn.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-reserve-email.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-plan-right-click.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-plan-select-box.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-multiple-list.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-multiple-dialog.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-barcode-scan.jpg)

*Bild 18: QR-/Barcode vor Ort einscannen*

Der Arbeitsplatz muss mit einem GR- oder Barcode ausgestattet sein, um diese Funktion nutzen zu können. Falls keine Sticker mit Code vorhanden sein sollten, können Sie den Arbeitsplatz im Dropdown über die Arbeitsplatznummer oder im Plan aussuchen.

![Ergebnis Plan](_images/flexi-workplace/mobile-barcode-dropdown.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-barcode-rel-menu.jpg)

*Bild 20: Menüeintrag im Eingabefeld*

![Ergebnis Plan](_images/flexi-workplace/mobile-barcode-plan.jpg)

*Bild 21: Arbeitsplatz in der Zeichnung auswählen*

Nachdem die Arbeitsplatznummer ausgewählt wurde erscheinen die Arbeitsplatz-Details im unteren Bereich. Neben den allgemeinen Arbeitsplatzinformationen inkl. Zeichnungsausschnitt und Bilder ist eine kleine Kalenderansicht vorhanden, die Sie durch Zoomen verkleinern und vergrößern können. Dort sind bereits vorhandene Reservierungen sichtbar. Noch weiter unten sehen Sie eine Liste mit den Reservierungen, die für die gesuchte Zeit gefunden worden sind. Dies geschiet nur bei Überschneidungen mit Ihrer gewünschten Zeit. Fall die Liste leer ist und keine Fehlemeldungen ersichtlich sind, ist der Button `Reservieren` im oberen Bereich aktiv und Sie können den Dialog für neue Reservierung durch einen Klick darauf aufrufen.

![Ergebnis Plan](_images/flexi-workplace/mobile-barcode-details-1.jpg)

*Bild 22: Arbeitsplatz-Details nach Eintragung der AR-Nummer (1)*

![Ergebnis Plan](_images/flexi-workplace/mobile-barcode-details-2.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-my-res.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-my-res-filter.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-all-res.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-all-res-filter.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-timeline-wpl.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-timeline-wpl-filter.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-timeline-wpl-reserve.jpg)

*Bild 30: Reservieren direkt in der Zeitachse nach Arbeitsplatz*

## Zeitachse nach Person

![Ergebnis Plan](_images/flexi-workplace/mobile-timeline-person.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-timeline-person-reserve.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-email.jpg)
...
![Ergebnis Plan](_images/flexi-workplace/mobile-email-event.jpg)
