<div style="margin:auto;text-align:center;width:100%;height:900px;color:#AAAAAA">
    ...
    <div style="height:160px"><img style="width:160px" src="_images/_title/reservations-space-app-logo.png"/></div>
    <div style="height:20px"></div>
...
![Reservierungen Indexseite](_images/reservations-space/index.png)
...
![Reservierung öffnen](_images/reservations-space/res-open.png)
...
![Nach Raum](_images/reservations-space/calendar-unit.png)
...
![Zeitachse](_images/reservations-space/timeline.png)
...
![Tabelle](_images/reservations-space/res-table.png)
...
![Filter Meeting](_images/reservations-space/filter-name-meeting.png)
...
![Filter Veranstalter](_images/reservations-space/filter-host.png)

> ... oder wenn Sie der Veranstalter sind

![Filter Veranstalter Ich](_images/reservations-space/filter-host-me.png)
...
![Filter Gebäude](_images/reservations-space/filter-building.png)
...
![Filter Leeren](_images/reservations-space/filter-clear.png)

> **Beispiel:**  Gebäude leeren. Geschoss / Raumeinheit / Raum-Typ werden identisch zurückgesetzt.

![Filter Gebaude leeren](_images/reservations-space/filter-building-clear.png)
...
![Neue Einzelraum-Reservierung](_images/reservations-space/new-one-time.png)

*Bild 7: Neue Einzelraum-Reservierung*

![Neue Einzelraum Reservierung Formular](_images/reservations-space/new-one-time-form.png)
...
![Neue Einzelraum Reservierung Form 2](_images/reservations-space/new-one-time-form-2.png)

*Bild 9: Einzelraum-Reservierung Formularansicht*

![Neue Einzelraum Reservierung Form 2](_images/reservations-space/new-one-time-form-3.png)
...
![Neue Einzelraum Reservierung Catering](_images/reservations-space/catering.png)

> Mit Klick auf das Bild können Sie es vergrößern.

![Neue Einzelraum Reservierung Catering](_images/reservations-space/catering-2.png)

> Anzahl *Cola / Wasser* eingeben.

![Neue Einzelraum Reservierung Catering](_images/reservations-space/catering-3.png)
...
![Inventar Vorhanden](_images/reservations-space/inventory.png)
...
![Inventar](_images/reservations-space/inventory-1.png)

*Bild 12: Zusatzinventar hinzufügen (1)*

![Inventar](_images/reservations-space/inventory-2.png)
...
![Teilnehmer](_images/reservations-space/participants.png)

*Bild 14: Teilnehmer hinzufügen*

![Teilnehmer mehrfache Auswahl](_images/reservations-space/participants-multiple.png)

*Bilder 15: Mehrere Teilnehmer in einem Schritt hinzufügen (1)*

![Teilnehmer mehrfache Auswahl](_images/reservations-space/participants-multiple-2.png)
...
![Kalender](_images/reservations-space/calendar-week.png)
...
![Res 1](_images/reservations-space/res-multiple.png)
...
![Res 2](_images/reservations-space/res-multiple-2.png)
...
![Res 3](_images/reservations-space/res-multiple-3.png)
...
![RES mehr4](_images/reservations-space/res-multiple-4.png)
...
![RES mehr5](_images/reservations-space/res-multiple-5.png)

*Bild 22: Reservierung mehrerer Räume bearbeiten*

![RES mehr6](_images/reservations-space/res-multiple-6.png)
...
![RES mehr7](_images/reservations-space/res-multiple-7.png)
...
![RES BuerLief1](_images/reservations-space/delivery-1.png)
...
![Res Bearbeiten](_images/reservations-space/res-edit.png)
